...
#Updated the above MaskedMHCA to accept query, key and value seperately for cross attention
...
class LocalMaskedMHCCA(nn.Module):
    """
    Local Multi Head Conv Cross Attention with mask
