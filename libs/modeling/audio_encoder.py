...
from torch.nn import Module, Sequential, LeakyReLU, MaxPool1d, Linear
...
class CNNAudioEncoder(Module):
    ...
    def __init__(self, n_features=(1024, 512, 256)):
        super().__init__()
        ...
        self.block0 = Sequential(
            ...
            Conv1d(n_dim0, n_dim1, kernel_size=3, stride=1, padding=2, build_activation=LeakyReLU),
            MaxPool1d(2)
        )

        self.block1 = Sequential(
            Conv1d(n_dim1, n_dim2, kernel_size=3, stride=1, padding=1, build_activation=LeakyReLU),
            Conv1d(n_dim2, n_dim2, kernel_size=3, stride=1, padding=1, build_activation=LeakyReLU),
            MaxPool1d(2)
        )
